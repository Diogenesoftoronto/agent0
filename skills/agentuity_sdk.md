# Skill: Agentuity Agent Development
...
### Development
```bash
agentuity dev        # Start development server with hot reload
agentuity build      # Build the project
```
...
### Agent Management
```bash
agentuity agent new  # Create a new agent interactively
```

### Environment Variables
```bash
agentuity env set KEY VALUE           # Set environment variable
agentuity env set --secret KEY VALUE  # Set secret (encrypted)
```
